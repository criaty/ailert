...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp firebase-criaty-ailert` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run firebase-criaty-ailert:deploy` - Deploy this app to firebase
* `nx run firebase-criaty-ailert:serve` - Serve this app using the firebase emulator
* `nx run firebase-criaty-ailert:build` - Build all functions associated with this app
* `nx run firebase-criaty-ailert:test` - Test all functions associated with this app
* `nx run firebase-criaty-ailert:lint` - Lint all functions associated with this app
